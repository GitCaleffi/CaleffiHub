export const MESSAGES = {
  ...
  NO_ACTIVE_BARCODE: "No active test barcode found.",
  USER_BARCODE_NOT_FOUND: "User or barcode not found.",
  BARCODE_VERIFIED: "Barcode validated successfully.",
  BARCODE_SENDTO_IOT: "Barcode send to IOT successfully.",
  BARCODE_MISMATCHED: "Barcode mismatch.",
  TEST_BARCODE_RETRIVED: "Test barcode retrieved successfully.",
